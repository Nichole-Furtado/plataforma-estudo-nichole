...
import { GraduationCap, Home, Code2, CalendarCheck, Wallet, Settings, Search, ListChecks, CheckSquare } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/checklist-semanal', icon: CheckSquare, label: 'Checklist' },
